 ...
 */
public class IfcClientRelNests extends IfcClientRelDecomposes {
    public final static String TAG = IfcClientRelNests.class.getSimpleName();
    ...
    public IfcClientRelNests() {
        relatedObjects = new ArrayList<IfcClientObjectDefinition>();
    }

    public IfcClientRelNests(IfcClientObjectDefinition relatingObject) {
        this.relatingObject = relatingObject;
        relatedObjects = new ArrayList<IfcClientObjectDefinition>();
    }

    public IfcClientRelNests(IfcClientObjectDefinition relatingObject, List<IfcClientObjectDefinition> relatedObjects) {
        this.relatingObject = relatingObject;
